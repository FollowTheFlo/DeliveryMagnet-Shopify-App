  ...
  //  const [value, setValue] = useState('manual');
    ...
    const successToast = successSaved ? (
      <div style={{height: '50px'}}>
        <Frame>
          <Toast content="Saved" onDismiss={() => setSuccessSaved(!successSaved)} duration={4500} />
        </Frame>
      </div>
    ) : null;
    ...
    return (
      ...
      <Layout>
        <Layout.Section oneThird>
          ...
          {
            serviceLoading &&  <div  className={styles.centerEl}><Spinner accessibilityLabel="Loading" size="small" /></div>
          }
            <Card.Section>             
            <TextField 
            type="number"
